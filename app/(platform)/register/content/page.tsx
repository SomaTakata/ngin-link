  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow">
      ...
      <p className="text-sm text-gray-600 mb-6">
        Add your own content below. You can also further customise your links and appearance later.
      </p>
      <div className="mb-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-gray-100 rounded">
            ...
            <Input className="flex-grow mx-3" defaultValue="https://shogo@x-2e.com" placeholder="Portfolio URL" />
          ...
          <div className="flex items-center justify-between p-3 bg-gray-100 rounded">
            ...
            <Input className="flex-grow mx-3" placeholder="Instagram username or URL" />
            <XIcon className="text-gray-500" />
          </div>
        </div>
      </div>
      <div className="mb-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-gray-100 rounded">
            ...
            <Input className="flex-grow mx-3" defaultValue="https://x.com/shogo@x-2e" placeholder="x.com" />
            <XIcon className="text-gray-500" />
          </div>
          <div className="flex items-center justify-between p-3 bg-gray-100 rounded">
            <LinkIcon className="text-gray-500" />
